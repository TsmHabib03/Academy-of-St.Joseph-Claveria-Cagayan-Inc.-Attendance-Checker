    ...
    <script>
        ...
        function showSuccess(data) {
            ...
            if (data.status === 'time_in') {
                ...
                if (sessionRaw) {
                    const sessionText = sessionRaw.includes('afternoon') || sessionRaw.includes('pm') ? 'PM' : (sessionRaw.includes('morning') || sessionRaw.includes('am') ? 'AM' : sessionRaw.toUpperCase());
                ...
                if (data.assigned_session && data.assigned_session && data.assigned_session !== data.session) {
